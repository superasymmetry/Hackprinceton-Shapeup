...
function normalizeBBox(bbox: Omit<HairMeasurementBBox, 'width' | 'height' | 'depth'>): HairMeasurementBBox {
  return {
    ...bbox,
...
export function buildHairMeasurementSnapshot(args: {
  ...
  params: HairParams;
  revision?: number;
  bbox?: Omit<HairMeasurementBBox, 'width' | 'height' | 'depth'>;
}): HairMeasurementSnapshot {
